...
function changeImage1() {
  ...
  switch (randomNumber1c) {
    case 1:
      document.getElementById("player1dice").src =
        "/images/diceImages/dice1.png";
      return 1;
      break;
    case 2:
      document.getElementById("player1dice").src =
        "/images/diceImages/dice2.png";
      return 2;
      break;
    case 3:
      document.getElementById("player1dice").src =
        "/images/diceImages/dice3.png";
      return 3;
      break;
    case 4:
      document.getElementById("player1dice").src =
        "/images/diceImages/dice4.png";
      return 4;
      break;
    case 5:
      document.getElementById("player1dice").src =
        "/images/diceImages/dice5.png";
      return 5;
      break;
    case 6:
      document.getElementById("player1dice").src =
        "/images/diceImages/dice6.png";
      return 6;
      break;
  }
}
...
function changeImage2() {
  ...
  switch (randomNumber2c) {
    case 1:
      document.getElementById("player2dice").src =
        "/images/diceImages/dice1.png";
      return 1;
      break;
    case 2:
